                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        validators={{required,minLength:minLength(3),maxLength:maxLength(15), isNumber }}
                                         />
                                        <Errors  className="text.danger" model=".telnum" show="touched" messages={{required:'Required. ', minLength:'Must be greater than 2 characters. ', maxLength:'Must be 15 number or less' , isNumber:' Must be a number' }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
